              ...
              child: Column(
                ...
                SizedBox(height: 5.0,),
                  Padding(
                    padding: const EdgeInsets.only(left: 10.0),
                    child: Text(
                      "Sigiriya Lion Rock is an ancient rock...", 
                      style: TextStyle(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 10.0),
                    child: Row(children: [
                      Icon(Icons.favorite_outline, color: Colors.black54, size: 25.0),
                      SizedBox(width: 10.0,),
                      Text(
                        "Like", 
                        style: TextStyle(
                      ...
                      SizedBox(width: 30.0,),
                      Icon(Icons.comment_outlined, color: Colors.black54, size: 25.0),
                      SizedBox(width: 10.0,),
                      Text(
                        "Comment", 
                        style: TextStyle(
